...
export default class AdotanteRepository implements InterfaceAdotanteRepository {
  ...
  async atulizaEnderecoAdotante(idAdotante: number, endereco: EnderecoEntity): Promise<{ success: boolean; message?: string; }> {
    try {
      ...
      console.log(error);
      return { success: false, message: 'Erro ao atualizar endereco do adotante' };
    }
  }
